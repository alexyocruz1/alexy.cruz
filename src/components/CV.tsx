    ...
    <div ref={componentRef} className="bg-white p-6 rounded shadow-2xl">
      ...
      <header className="text-center mb-6">
        ...
        <div className="flex justify-center items-center space-x-4 border-t border-b border-gray-300 py-2">
          <p className="text-base border-r border-gray-300 pr-4">Phone: <a href="tel:+529844505332" className="font-bold text-blue-500 hover:underline">+52 984 450 5332</a></p>
          <p className="text-base border-r border-gray-300 pr-4">Email: <a href="mailto:alexyocruz1@gmail.com" className="font-bold text-blue-500 hover:underline">alexyocruz1@gmail.com</a></p>
          <p className="text-base">LinkedIn: <a href="https://www.linkedin.com/in/alexy-cruz-72777114b/" className='font-bold text-blue-500 hover:underline'>linkedin.com/in/alexy-cruz</a></p>
        </div>
      </header>
      ...
      <section className="mb-6 border-t border-gray-300 pt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="mb-4">
            <h3 className="text-lg font-bold">Frontend Developer at Unique Vacations</h3>
          ...
          <div className="mb-4">
            <h3 className="text-lg font-bold">Full Stack Developer / Salesforce Developer at Experenta</h3>
